...
med_age_timeline_total_arr <- apply(age_results[as.character(2025:2040),,,"new",,], c("year", "age", "sim"), sum)
med_age_timeline_raw_arr <- array(c(age_results[as.character(2025:2040),,,"new",,],
...
all_threads <- lapply(1:25, function(i) {
    filename = paste0("../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/new/thread_",
                      i, ".Rdata")
...
save(med_age_timeline_arr, file="../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/new/med_age_timeline_arr.Rdata")
...
save(med_age_delta_data, file="../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/new/med_age_delta_data.Rdata")
...
save(med_age_timeline_data, file="../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/new/med_age_timeline_data.Rdata")
