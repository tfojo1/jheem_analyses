...
save(this_thread_BLACK_output,
     file = paste0("../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/race/Black_thread_",
                   THREAD_NUMBER, ".Rdata"))
...
save(this_thread_HISP_output,
     file = paste0("../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/race/HISP_thread_",
                   THREAD_NUMBER, ".Rdata"))
...
save(this_thread_OTHER_output,
     file = paste0("../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/race/OTHER_thread_",
                   THREAD_NUMBER, ".Rdata"))
