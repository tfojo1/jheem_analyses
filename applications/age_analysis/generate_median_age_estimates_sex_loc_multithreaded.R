...
save(this_thread_MSM_output,
     file = paste0("../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/sex/loc_MSM_thread_",
                   THREAD_NUMBER, ".Rdata"))
...
save(this_thread_HET_output,
     file = paste0("../jheem_analyses/applications/age_analysis/Rdata Objects/median_age_estimates/sex/loc_HET_thread_",
                   THREAD_NUMBER, ".Rdata"))
