...
SURVEILLANCE.MANAGER$put(data = 1368, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MO"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 3021, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MS"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 2872, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MI"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 4863, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "SC"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 5829, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "TN"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 1284, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "AZ"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 22284, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "GA"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 19665, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "TX"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 2107, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MA"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 13908, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "CA"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 3097, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "OH"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 8297, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "PA"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 81477, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "FL"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 9505, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "NV"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 10345, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "NY"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 2430, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "WI"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 2983, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "KY"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 5057, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "IL"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 1142, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MD"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 1488, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "WA"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 6597, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "IN"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
SURVEILLANCE.MANAGER$put(data = 9944, outcome = "number.eligible", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "NJ"), url = "www.cdc.gov", details = "CDC State Prevention Reports") 
...
SURVEILLANCE.MANAGER$put(data = 0.465, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MO"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MS"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.465, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MI"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "SC"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "TN"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.321, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "AZ"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "GA"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "TX"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.437, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MA"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.321, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "CA"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.465, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "OH"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.437, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "PA"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "FL"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.321, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "NV"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.437, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "NY"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.465, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "WI"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "KY"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.465, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "IL"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.54, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "MD"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.321, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "WA"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.465, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "IN"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
SURVEILLANCE.MANAGER$put(data = 0.437, outcome = "proportion.referred", source = "cdc.hiv", ontology.name = "cdc",dimension.values = list(year = "2022", location = "NJ"), url = "www.cdc.gov", details = "Integrated HIV Surveillance and Prevention Programs for Health Departments") 
