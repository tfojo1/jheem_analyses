...
load("../jheem_analyses/prelim_results/init.transmission.sim_2024-03-01_C.12580.Rdata")
sim.new = sim
...
round(cbind(params.old[c(par.names.pop,par.names.transmission)],params.new[c(par.names.pop,par.names.transmission)]),4)
(cbind(params.old[c(par.names.pop,par.names.transmission)],params.new[c(par.names.pop,par.names.transmission)]))
round(cbind(params.new[c(par.names.pop,par.names.transmission)]),4)
