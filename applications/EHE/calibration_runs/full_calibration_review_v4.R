...
#params.manual[incident.idu.params.0] = 10
params.manual[incident.idu.params.2] = 0.05
sim.manual = engine$run(parameters = params.manual)

# which likelihoods are WORSE now that I've made IDU better? 
      # new, diagnosed.prevalence, aids.diagnoses, awareness
