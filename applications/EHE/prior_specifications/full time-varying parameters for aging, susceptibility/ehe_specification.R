...
register.model.element(EHE.SPECIFICATION,
                       name = 'sexual.susceptibility.by.age',
                       get.value.function = get.sexual.susceptibility.by.age,
                       scale = 'ratio')
...
register.model.quantity.subset(EHE.SPECIFICATION,
                               ...
                               value = expression(msm.trates * msm.peak.multiplier * sexual.susceptibility.by.age))

register.model.quantity.subset(EHE.SPECIFICATION,
                               name = 'sexual.transmission.rates',
                               applies.to = list(sex.from=c('heterosexual_male','msm'),
                                                 sex.to=c('female')),
                               value = expression(heterosexual.trates * sexual.susceptibility.by.age))

register.model.quantity.subset(EHE.SPECIFICATION,
                               name = 'sexual.transmission.rates',
                               applies.to = list(sex.from=c('female'),
                                                 sex.to=c('heterosexual_male','msm')),
                               value = expression(heterosexual.trates * male.vs.female.heterosexual.rr * sexual.susceptibility.by.age))
...
register.model.quantity.subset(EHE.SPECIFICATION,
                               name = 'flattened.sexual.transmission.rates',
                               applies.to = list(sex.to='msm'),
                               value = expression(global.trate * msm.trates * msm.peak.multiplier * sexual.susceptibility.by.age))

register.model.quantity.subset(EHE.SPECIFICATION,
                               name = 'flattened.sexual.transmission.rates',
                               applies.to = list(sex.to='female'),
                               value = expression(global.trate * heterosexual.trates * sexual.susceptibility.by.age))

register.model.quantity.subset(EHE.SPECIFICATION,
                               name = 'flattened.sexual.transmission.rates',
                               applies.to = list(sex.to='heterosexual_male'),
                               value = expression(global.trate * heterosexual.trates * male.vs.female.heterosexual.rr * sexual.susceptibility.by.age))
...
register.model.element(EHE.SPECIFICATION,
                       name = 'idu.susceptibility.by.age',
                       get.value.function = get.idu.susceptibility.by.age,
                       scale = 'ratio')
