...
EHE.SPECIFICATION = create.jheem.specification(version = 'ehe',
                                               ...
                                               compartments.for.infected.only = list(
                                                   continuum = c('undiagnosed_acute', 'undiagnosed_from_prep_acute', 
                                                                 'undiagnosed_chronic', 'diagnosed_chronic',
                                                                 'undiagnosed_low_cd4', 'diagnosed_low_cd4')
                                               ),
                                               ...
                                               compartment.value.aliases = list(
                                                   ...
                                                   first.diagnosed.states=c('diagnosed_chronic','diagnosed_low_cd4'),
                                                   diagnosed.states=c('diagnosed_chronic','diagnosed_low_cd4'),
                                                   undiagnosed.states=c('undiagnosed_acute', 'undiagnosed_from_prep_acute', 
                                                                        'undiagnosed_chronic', 'undiagnosed_low_cd4'),
                                                   undiagnosed.from.prep.states='undiagnosed_from_prep_acute',
                                                   undiagnosed.no.prep.states=c('undiagnosed_acute', 
                                                                                'undiagnosed_chronic', 'undiagnosed_low_cd4'),
                                                   diagnosed.aids.states = 'diagnosed_low_cd4',
                                                   infected.states.except.diagnosed.aids = c('undiagnosed_acute', 'undiagnosed_from_prep_acute', 
                                                                                             'undiagnosed_chronic', 'diagnosed_chronic',
                                                                                             'undiagnosed_low_cd4'),
                                                   acute.stages = c('undiagnosed_acute', 'undiagnosed_from_prep_acute'),
                                                   chronic.stages = c('undiagnosed_chronic', 'diagnosed_chronic',
                                                                      'undiagnosed_low_cd4', 'diagnosed_low_cd4'),
                                                   low.cd4.stages = c('undiagnosed_low_cd4', 'diagnosed_low_cd4'),
...
TESTING.LAST.RAMP.YEAR = 1995
TESTING.LAST.ZERO.YEAR = 1982
TESTING.FIRST.YEAR.FRACTION.OF.RAMP = (1/1.5)^(TESTING.LAST.RAMP.YEAR-TESTING.LAST.ZERO.YEAR-1)

TESTING.RAMP.TIMES = TESTING.LAST.ZERO.YEAR:TESTING.LAST.RAMP.YEAR
TESTING.RAMP.VALUES = c(0,TESTING.FIRST.YEAR.FRACTION.OF.RAMP*1.5^(TESTING.RAMP.TIMES[-1]-TESTING.RAMP.TIMES[2]))
names(TESTING.RAMP.TIMES) = names(TESTING.RAMP.VALUES) = as.character(TESTING.RAMP.TIMES)
register.model.element(EHE.SPECIFICATION,
                       name = 'testing.ramp.up',
                       scale = 'proportion',
                       functional.form = create.linear.spline.functional.form(knot.times = TESTING.RAMP.TIMES,
                                                                              knot.values = as.list(TESTING.RAMP.VALUES)),
                       functional.form.from.time = TESTING.RAMP.TIMES[1])

register.model.element(EHE.SPECIFICATION,
                       name = 'testing.ramp.up.vs.current.rr',
                       scale = 'proportion',
                       value = 0.5)

register.model.element(EHE.SPECIFICATION,
                       name = 'general.population.screening.without.covid',
                       scale = 'rate',
...
register.model.quantity(EHE.SPECIFICATION,
                        ...
                        scale = 'rate',
                        value = expression(
                          general.population.screening.without.covid * testing.ramp.up * testing.ramp.up.vs.current.rr *
                            (1-(1-max.covid.effect.screening.reduction) * covid.on *
                               (1-screening.mobility.correlation+(screening.mobility.correlation*covid.mobility.change))))
)

register.model.quantity(EHE.SPECIFICATION,
                       name = 'undiagnosed.screening.increase',
                       value = expression(
                         undiagnosed.screening.increase.without.covid *
                           (1-(1-max.covid.effect.undiagnosed.screening.rr.increase) * covid.on *
                              (1-undiagnosed.screening.rr.mobility.correlation+
                                 (undiagnosed.screening.rr.mobility.correlation*covid.mobility.change)))), 
                       scale = 'non.negative.number')

register.model.element(EHE.SPECIFICATION,
                       name = 'undiagnosed.screening.increase.without.covid',
                       get.functional.form.function = get.undiagnosed.testing.increase.functional.form, 
                       scale = 'non.negative.number')

register.model.quantity(EHE.SPECIFICATION,
                        name = 'screening.of.undiagnosed',
                        value = expression(general.population.screening*(1+undiagnosed.screening.increase)))

register.model.element(EHE.SPECIFICATION,
                       name = 'max.covid.effect.screening.reduction',
                       scale = 'ratio',
                       get.functional.form.function = get.covid.max.testing.effect)

register.model.element(EHE.SPECIFICATION,
                       name = 'max.covid.effect.undiagnosed.screening.rr.increase',
                       scale = 'ratio',
                       get.functional.form.function = get.undiagnosed.testing.covid.rr.functional.form) 

# get.covid.max.screening.effect is a relative risk (e.g., 0.8 if testing is 80% of what it would be without covid)
# screening.no.covid is time-varying, max.covid.effect.screening.reduction is (1- relative risk) (static)
# if screening mobility correlation is 0, always the max reduction; if screening mobility correlation is 1, moves the same as mobility
# if covid.on = 0 , go back to screening.no.covid 
...
register.model.quantity.subset(EHE.SPECIFICATION,
                               ...
                               value = 'suppression.of.diagnosed.chronic.without.covid')

register.model.quantity.subset(EHE.SPECIFICATION,
                               name = 'suppression.of.diagnosed.without.covid',
                               applies.to = list(continuum='diagnosed_low_cd4'),
                               value = 'suppression.of.diagnosed.low.cd4.without.covid')

register.model.element(EHE.SPECIFICATION,
                       name = 'suppression.of.diagnosed.chronic.without.covid',
                       scale = 'proportion',
                       ...
                       functional.form.from.time = 2008,     
                       
                       ramp.times = 1996,
                       ramp.values = 0)

# register.model.element(EHE.SPECIFICATION,
#                        name = 'suppression.of.diagnosed.low.cd4.without.covid',
#                        scale = 'proportion',
#                        
#                        get.functional.form.function = get.suppression.functional.form,
#                        anchor.year = 2008,
...
register.model.element(EHE.SPECIFICATION,
                       name = 'low.cd4.engagement',
                       scale = 'proportion',
                       functional.form = create.linear.spline.functional.form(knot.times = c(pre.art = 1996,
                                                                                             post.art = 2002),
                                                                              knot.values = list(pre.art = 0,
                                                                                                 post.art = 0.8)),
                       functional.form.from.time = 1996)


register.model.element(EHE.SPECIFICATION,
                       name = 'suppression.low.cd4.ramp',
                       scale = 'proportion',
                       functional.form = create.linear.spline.functional.form(knot.times = c(start=1996,
                                                                                             end=1998),
                                                                              knot.values = list(start=0,
                                                                                                 end=1)),
                       functional.form.from.time = 1996)
...
register.model.quantity(EHE.SPECIFICATION,
                        name = 'suppression.of.diagnosed.low.cd4.without.covid',
                        scale = 'proportion',
                        value = expression(suppression.low.cd4.ramp * low.cd4.engagement * cd4.recovery.rate * (1/cd4.recovery.rate - time.to.suppression)))
...
register.transition(EHE.SPECIFICATION,
                    ...
                    to.compartments = 'diagnosed_chronic',
                    groups = 'infected',
                    value = 'screening.of.undiagnosed')

# To Undiagnosed/Low CD4
register.transition(EHE.SPECIFICATION,
                    dimension = 'continuum',
                    groups = 'infected',
                    from.compartments = 'undiagnosed_chronic',
                    to.compartments = 'undiagnosed_low_cd4',
                    value = 'cd4.decline.rate')

register.model.element(EHE.SPECIFICATION,
                       name = 'cd4.decline.rate',
                       scale = 'ratio',
                       value = log(2)/8)

#-- From Diagnosed/Chronic --#

# To Diagnosed/Low CD4
register.transition(EHE.SPECIFICATION,
                    dimension = 'continuum',
                    groups = 'infected',
                    from.compartments = 'diagnosed_chronic',
                    to.compartments = 'diagnosed_low_cd4',
                    value = expression(cd4.decline.rate * (1-suppression.of.diagnosed)))

#-- From Undiagnosed/Low CD4 --#

# To Diagnosed/Low CD4
register.transition(EHE.SPECIFICATION,
                    dimension = 'continuum',
                    from.compartments = 'undiagnosed_low_cd4',
                    to.compartments = 'diagnosed_low_cd4',
                    groups = 'infected',
                    value = expression(screening.of.undiagnosed + low.cd4.symptomatic.testing.rate * testing.ramp.up))

register.model.element(EHE.SPECIFICATION,
                       name = 'low.cd4.symptomatic.testing.rate',
                       scale = 'rate',
                       value = exp(-0.5692455)) # see ehe_parameter_calculations.R for citations and derivation


#-- From Diagnosed/Low CD4 --#

# To Diagnosed/Chronic
register.transition(EHE.SPECIFICATION,
                    dimension = 'continuum',
                    from.compartments = 'diagnosed_low_cd4',
                    to.compartments = 'diagnosed_chronic',
                    groups = 'infected',
                    value = expression(cd4.recovery.rate * suppression.of.diagnosed))

register.model.element(EHE.SPECIFICATION,
                       name = 'cd4.recovery.rate',
                       scale = 'ratio',
                       value = 1)
...
register.mortality(EHE.SPECIFICATION, 
                   ...
                   groups = 'infected', 
                   applies.to = list(continuum='low.cd4.stages'),
                   mortality.rate.value = 'low.cd4.mortality.rate')

register.model.element(EHE.SPECIFICATION,
                       name = 'low.cd4.no.art.mortality.rate',
                       scale = 'rate',
                       value = 0.33) # https://www.sciencedirect.com/science/article/pii/S0033350616300646?via%3Dihub

register.model.element(EHE.SPECIFICATION,
                       name = 'low.cd4.with.art.mortality.rate',
                       scale = 'rate',
                       value = 0.045) # https://www.sciencedirect.com/science/article/pii/S0033350616300646?via%3Dihub

register.model.quantity(EHE.SPECIFICATION,
                        name = 'low.cd4.mortality.rate',
                        scale = 'rate',
                        value = expression((1-low.cd4.engagement)*low.cd4.no.art.mortality.rate + low.cd4.engagement*low.cd4.with.art.mortality.rate))
...
register.transmission(EHE.SPECIFICATION,
                      ...
                      new.infections.applies.to = list(continuum='acute.stages'))
...
register.model.element(EHE.SPECIFICATION,
                       ...
                       # functional.form.from.time = 2000,
                       # ramp.times = c(1960, 1970, 1980, 1995),
                       # ramp.values = c(pre.peak=1, peak.start=1, peak.end=1, t0.start=1))
                       
                       functional.form.from.time = 2000,
                       ramp.times = c(1970, 1980, 1995),
...
#-- Testing --#
register.model.element(EHE.SPECIFICATION,
                       name = 'screening.mobility.correlation',
                       scale = 'proportion',
                       value = 1)

register.model.element(EHE.SPECIFICATION,
                       name = 'undiagnosed.screening.rr.mobility.correlation',
                       scale = 'proportion',
                       value = 1)
...
#                                                             singular.unit = 'case'),
#                  dimension = 'continuum',
#                  from.compartments = 'infected.states.except.diagnosed.aids',
#                  to.compartments = 'diagnosed.aids.states',
#                  keep.dimensions = c('location','age','race','sex','risk'),
#                  corresponding.data.outcome = 'aids.diagnoses')
...
track.point.outcome(EHE.SPECIFICATION,
                    ...
                    value = 'general.population.screening',
...
track.cumulative.proportion.from.rate(EHE.SPECIFICATION,
                                      ...
                                      outcome.metadata = NULL,
                                      rate.value = 'general.population.screening',
...
track.integrated.outcome(EHE.SPECIFICATION,
                         ...
                         scale = 'non.negative.number',
                         value.to.integrate = 'uninfected',
                         multiply.by = 'general.population.screening',
                         save = F)
...
track.dynamic.outcome(EHE.SPECIFICATION,
                      ...
                      subset.dimension.values = list(continuum = "diagnosed_low_cd4"), # maybe include this? 
                      from.year = 1980, 
                      to.year = 2001)
