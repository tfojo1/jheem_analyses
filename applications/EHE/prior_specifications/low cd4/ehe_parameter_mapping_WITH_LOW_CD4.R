...
EHE.APPLY.PARAMETERS.FN = function(model.settings, parameters)
{
    ...
    set.ehe.alphas.from.parameters(model.settings,
                                   element.name = 'suppression.of.diagnosed.chronic.without.covid',
                                   parameters = parameters,
                                   parameter.suffixes = c(intercept='.suppressed.or', slope='.suppressed.slope.or'),
                                   idu.applies.to.in.remission = F)
    
    # set.ehe.alphas.from.parameters(model.settings,
    #                                element.name = 'suppression.of.diagnosed.low.cd4.without.covid',
    #                                parameters = parameters,
    #                                parameter.suffixes = c(intercept='.suppressed.or'),
    #                                idu.applies.to.in.remission = F)
    # 
    # set.element.functional.form.main.effect.alphas(model.settings,
    #                                                element.name = 'suppression.of.diagnosed.low.cd4.without.covid',
    #                                                alpha.name = 'slope',
    #                                                values = parameters['low.cd4.suppressed.slope.or'],
    #                                                dimensions = "all")
    
    #-- Testing --#
    set.ehe.alphas.from.parameters(model.settings,
                                   element.name = 'general.population.screening.without.covid',
                                   parameters = parameters,
                                   parameter.suffixes = c(intercept='.proportion.tested.or', slope='.proportion.tested.slope.or'),
                                   idu.applies.to.in.remission = F,
                                   throw.error.if.no.parameters = F)

    # model.settings$set.element.ramp.values(element.name = 'general.population.screening.without.covid',
    ...
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   element.name = "undiagnosed.screening.increase.without.covid",
                                                   alpha.name = "value",
    ...
    for(race in specification.metadata$dim.names$race){
      set.element.functional.form.main.effect.alphas(model.settings,
                                                     ...
                                                     alpha.name = "value",
                                                     values = parameters[paste0(race,'.sexual.transmission.covid.multiplier')],
                                                     applies.to.dimension.values=list(race=race))
    }
    ...
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   ...
                                                   applies.to.dimension.values=list(age=c("13-24 years","25-34 years"))) # can just do 1:2
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   element.name = "max.covid.effect.sexual.transmission.reduction",
                                                   alpha.name = "value",
    ...
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   ...
                                                   applies.to.dimension.values=list(age=c("55+ years")))
    ...
    for(race in specification.metadata$dim.names$race){
      set.element.functional.form.main.effect.alphas(model.settings,
                                                     element.name = "max.covid.effect.screening.reduction",
                                                     alpha.name = "value",
                                                     values = parameters[paste0(race,'.testing.covid.multiplier')],
                                                     applies.to.dimension.values=list(race=race))
    }
    ...
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   ...
                                                   applies.to.dimension.values=list(age=c("13-24 years","25-34 years")))
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   element.name = "max.covid.effect.screening.reduction",
                                                   alpha.name = "value",
    ...
    set.element.functional.form.main.effect.alphas(model.settings,
                                                   element.name = "max.covid.effect.undiagnosed.screening.rr.increase",
                                                   alpha.name = "value",
...
set.ehe.idu.from.parameters = function(model.settings,
                                       parameters,
                                       times = c(0,1,2)) # must align with idu_input_manager
{
    specification.metadata = model.settings$specification.metadata
    races = specification.metadata$dim.names$race
    ages = specification.metadata$dim.names$age
