...
.save_fig(fig1, .default_fig_dir(), "fig2_noint", width = 8, height = 8, dpi = 300)
...
ggsave(file.path(FIG.DIR, "fig3_heatmaps.png"), fig2,
...
ggsave(file.path(FIG.DIR, "fig3a_crit_coverage.png"), fig3,
