...
p.heat.A <- .mk.heat(tbl.rel.2022, "msm",   "A: MSM (vs. 2022 baseline)")
p.heat.B <- .mk.heat(tbl.rel.2022, "Total", "B: Total Population (vs. 2022 baseline)")
p.heat.C <- .mk.heat(tbl.rel.2030,          "msm",   "C: MSM (vs. 2030 No Intervention)")
p.heat.D <- .mk.heat(tbl.rel.2030,          "Total", "D: Total Population (vs. 2030 No Intervention)")
...
# ****************************************************************************************************
# FIGURE 5 -- DOXY-PEP IMPACT AT ONE COVERAGE LEVEL (replaces Table 2 in the paper)
# ****************************************************************************************************
#
