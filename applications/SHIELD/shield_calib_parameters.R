source(file.path(JHEEM.ANALYSES.PATH, "applications/SHIELD/shield_base_parameters.R"))
source(file.path(JHEEM.ANALYSES.PATH, "applications/SHIELD/inputs/input_estimate_sexual_activity_by_age.R"))
source(file.path(JHEEM.ANALYSES.PATH, "applications/SHIELD/R/shield_multivariate_spline_prior.R"))
