...
#       nohup bash applications/SHIELD/launchers/launch_interventions.sh > applications/SHIELD/logs/launcher.out 2>&1 &
#   Kill Runs:
...
#       tail -f applications/SHIELD/logs/<loc>_<calib_code>_interventions.out
#
# HOW IT WORKS
...
#   Check logs/<loc>_<calibration_code>_interventions.out for the R-level error message.
