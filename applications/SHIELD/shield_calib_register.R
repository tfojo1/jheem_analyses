...
#04.25: <pop.demog.shield> Zoe has update the Surveillance data by race for the population. inverted emigration param,
#04.25: <pop.demog.wEmigration> same chain run with 6 parameters by Ryan
#04.28: <pop.demog.NYC> NYC simulation as is


register.calibration.info('pop.demog.NYC.RF', 
