...
#' @param location PARAM_DESCRIPTION
#' @param specification.metadata PARAM_DESCRIPTION
#' @param years PARAM_DESCRIPTION, Default: DEFAULT.POPULATION.YEARS
...
#'  }
#' }
#' @rdname get.base.initial.male.population
#' @export 
...
#'  }
#' }
#' @rdname get.base.initial.female.population
#' @export 
...
#' }
#' @seealso 
#'  \code{\link[locations]{get.contained.locations}}
#' @rdname get.base.initial.population.for.sex
#' @export 
#' @importFrom locations get.contained.locations
...
#' @title FUNCTION_TITLE
#' @description FUNCTION_DESCRIPTION
#' @param age.mixing.sd.mult PARAM_DESCRIPTION
#' @param single.year.female.age.counts PARAM_DESCRIPTION
#' @param single.year.age.sexual.availability PARAM_DESCRIPTION
#' @param specification.metadata PARAM_DESCRIPTION
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
...
#'  }
#' }
#' @rdname get.female.sexual.age.contact.proportions
#' @export 
...
#' @description FUNCTION_DESCRIPTION
#' @param age.mixing.sd.mult PARAM_DESCRIPTION
#' @param single.year.msm.age.counts PARAM_DESCRIPTION
#' @param single.year.age.sexual.availability PARAM_DESCRIPTION
#' @param specification.metadata PARAM_DESCRIPTION
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
...
#'  }
#' }
#' @rdname get.msm.sexual.age.contact.proportions
#' @export 
...
#' @description FUNCTION_DESCRIPTION
#' @param age.mixing.sd.mult PARAM_DESCRIPTION
#' @param single.year.heterosexual.male.age.counts PARAM_DESCRIPTION
#' @param single.year.age.sexual.availability PARAM_DESCRIPTION
#' @param specification.metadata PARAM_DESCRIPTION
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
...
#'  }
#' }
#' @rdname get.heterosexual.male.sexual.age.contact.proportions
#' @export 
...
#' @param location PARAM_DESCRIPTION
#' @param age.mixing.sd.mult PARAM_DESCRIPTION
#' @param age.model PARAM_DESCRIPTION
#' @param age.counts PARAM_DESCRIPTION
#' @param availability PARAM_DESCRIPTION
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
#' \dontrun{
...
#'  }
#' }
#' @rdname do.get.age.contact.proportions.for.model
#' @export 
...
#' @description FUNCTION_DESCRIPTION
#' @param location PARAM_DESCRIPTION
#' @param population.years PARAM_DESCRIPTION, Default: DEFAULT.POPULATION.YEARS
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
#' \dontrun{
...
#'  }
#' }
#' @rdname get.female.single.year.age.counts
#' @export 
...
#'  }
#' }
#' @rdname get.male.single.year.age.counts
#' @export 
...
#'  }
#' }
#' @rdname get.msm.single.year.age.counts
#' @export 
...
#'  }
#' }
#' @rdname get.heterosexual.male.single.year.age.counts
#' @export 
...
#'  }
#' }
#' @rdname get.sexual.availability
#' @export 
