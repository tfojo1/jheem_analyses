...
{
    params.manual <- simsetBaltimore1$get.params()
    #
...
lik$compare.sims(simsetBaltimore1$last.sim(),sim.manual, piecewise = T) #values greater than 1 mean
