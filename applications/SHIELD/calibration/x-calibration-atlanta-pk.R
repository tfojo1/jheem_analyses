...
simsetAtlanta0 <- retrieve.simulation.set("shield",
                                            location = LOCATION,calibration.code = "calib.2.7.stage0.az",n.sim = 400)
simsetAtlanta1 <- retrieve.simulation.set("shield",
...
# {
#     params.manual <- simset1$get.params()
#     #
#     params.manual['transmission.rate.future.change.mult']<-1.2
...
# 
# # COMPARE LIKELIHOODS ---- 
# lik=lik.inst.stage1B$instantiate.likelihood(VERSION,LOCATION)
# 
# 
