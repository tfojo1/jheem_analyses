...
ADAP.START.YEAR = 2026 + 2/12 # Fixed this! 2 instead of 6
...
LOSE.ADAP.FRACTION = rep(0.369,1000)
...
adap.cessation = create.intervention(adap.cessation.expansion.effect,
                                        ...
                                        parameters = rbind(
                                            ...
                                            LOSE.ADAP.FRACTION),
                                        WHOLE.POPULATION, 
                                        code = paste0("adap.36.9.end",rw.intervention.suffix))
...
adap.cessation.cons = create.intervention(adap.cessation.expansion.effect,
                                             ...
                                             parameters = rbind(
                                                 ...
                                                 LOSE.ADAP.FRACTION),
                                             WHOLE.POPULATION, 
                                             code = paste0("adap.36.9.end.cons",rw.intervention.suffix))
