...
write.csv(tab, file='../../results/nbc/cdc_testing_end_cd_incidence_relative_increase.csv', row.names = F)
...
write.csv(tab2, file='../../results/nbc/cdc_testing_end_cd_incidence_absolute_increase.csv', row.names = F)
