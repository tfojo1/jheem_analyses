...
sim.collection=create.simset.collection(version="rw", calibration.code = CALIBRATION.CODE,
                                        locations = LOCATIONS, interventions = c('noint','adap.50.end.26'), #,'adap.50.end.cons.26'
                                        n.sim=N.SIM)
...
filename = paste0('Q:results/ryan_white/ryan_white_results_state_50_adap_', RW.ANCHOR.YEAR, "_", Sys.Date(), ".Rdata")
