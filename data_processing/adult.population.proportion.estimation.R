...
#This gives a lot of NAs.  It looks like the issue is that there are counties that are not included in the cdc_wonder data.  That pull from the surveillance manager has to be from wonder 
#bc it was the most recent data.  So if there isn't a population value in cdc wonder then there won't be an adult.population value.
