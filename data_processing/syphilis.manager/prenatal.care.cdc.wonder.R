...
DATA.DIR.PRENATAL=file.path(Q_ROOT, "data_raw/syphilis.manager/prenatal.care.cdc.wonder/total")
...
DATA.DIR.PRENATAL.AGE=file.path(Q_ROOT, "data_raw/syphilis.manager/prenatal.care.cdc.wonder/age")
...
DATA.DIR.PRENATAL.RACE=file.path(Q_ROOT, "data_raw/syphilis.manager/prenatal.care.cdc.wonder/race.eth")
...
DATA.DIR.PRENATAL.THREE=file.path(Q_ROOT, "data_raw/syphilis.manager/prenatal.care.cdc.wonder/age.race.eth")
