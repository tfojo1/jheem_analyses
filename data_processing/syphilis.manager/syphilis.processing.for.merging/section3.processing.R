...
put.msa.data.as.new.source.NEW(outcome = 'prenatal.screening.denominator',
...
put.msa.data.as.new.source.NEW(outcome = 'female.population.denominator.for.fertility.rate',
                               from.source.name = 'cdc.wonder.natality',
                               to.source.name = 'cdc.wonder.aggregated.population',
                               to.locations =  SHIELD.MSAS.OF.INTEREST,  #Think of this as containing location 
                               geographic.type.from = 'COUNTY',
