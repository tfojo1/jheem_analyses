...
DATA.DIR.SDH=file.path(Q_ROOT, "data_raw/syphilis.manager/sdh")
...
# SDH- Rural Area (This has a separate source and is by STATE) ------------
  ...
  DATA.DIR.RURAL=file.path(Q_ROOT, "data_raw/syphilis.manager/sdh/rural.area")
...
# National Level SDH Data -------------------------------------------------
  ...
  DATA.DIR.SDH.NATIONAL=file.path(Q_ROOT, "data_raw/syphilis.manager/sdh/national")
