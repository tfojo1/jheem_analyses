...
DATA.DIR.NAT.IMM=file.path(Q_ROOT, "data_raw/syphilis.manager/national.immigration")
...
# SEX ---------------------------------------------------------------------
DATA.DIR.IMM.SEX=file.path(Q_ROOT, "data_raw/syphilis.manager/national.immigration/sex")
...
DATA.DIR.IMM.race=file.path(Q_ROOT, "data_raw/syphilis.manager/national.immigration/race")
