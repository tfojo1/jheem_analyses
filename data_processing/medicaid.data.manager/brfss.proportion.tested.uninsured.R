...
brfss.uninsured.template = lapply(brfss_file_state_list, function(file){
...
total.uninsured = lapply(brfss.uninsured.template, function(file){
...
# Create Template to Calculate Proportion Tested amongst Uninsured ---------------------------

#HIVSTD3 = date of last test
#HIVTST6 and HIVTST7 = ever tested for hiv; renamed 'ever.tested'

uninsured.proportion.tested.template = lapply(brfss.uninsured.template, function(file){
...
# Calculate Total Proportion Tested Uninsured -----------------------------
total.proportion.tested.uninsured = lapply(uninsured.proportion.tested.template, function(file){
