...
#SBATCH --mem=16G
#SBATCH --output=/scratch4/pkasaie1/azalesak/jheem/code/jheem_analyses/cluster_scripts/outputs/ehe/C.35620/setup_init.transmission.ehe.bat/setup_init.transmission.ehe.out
