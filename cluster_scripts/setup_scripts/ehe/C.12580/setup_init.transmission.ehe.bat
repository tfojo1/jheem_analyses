...
Rscript cluster_scripts/set_up_calibration.R ehe C.12580 init.transmission.ehe applications/EHE/ehe_specification.R applications/EHE/calibration_runs/ehe_register_calibrations.R