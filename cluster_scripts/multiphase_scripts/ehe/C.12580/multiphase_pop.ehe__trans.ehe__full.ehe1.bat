...
Rscript cluster_scripts/do_multiphase_calibration.R ehe C.12580 pop.ehe__trans.ehe__full.ehe 1 applications/EHE/ehe_specification.R applications/EHE/calibration_runs/ehe_register_calibrations.R