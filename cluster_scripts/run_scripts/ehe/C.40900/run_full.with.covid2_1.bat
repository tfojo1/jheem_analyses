...
Rscript cluster_scripts/run_calibration.R ehe C.40900 full.with.covid2 1 applications/EHE/ehe_specification.R applications/EHE/calibration_runs/ehe_register_calibrations.R