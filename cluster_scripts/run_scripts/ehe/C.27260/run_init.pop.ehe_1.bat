...
#SBATCH --job-name=run_ehe_C.27260_init.pop.ehe_1
#SBATCH --mem=16G
#SBATCH --output=/scratch4/pkasaie1//jheem/code/jheem_analyses/cluster_scripts/outputs/ehe/C.27260/run_init.pop.ehe_1.out
