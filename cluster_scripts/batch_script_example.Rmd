...
```{r, eval=FALSE}
make.master.setup.script("my_example_setup_script",
...
make.run.scripts(MY_LOCATIONS,
                 ...
                 calibration.code='init.pop.ehe',
                 chains=1)
make.master.run.script("my_example_run_script",
                       locations=MY_LOCATIONS,
                       version='ehe',
                       calibration.code='init.pop.ehe',
                       chains=1)
...
### Export the assembled simsets using the CLI of your local desktop
```
